...
<div style={{ overflow: 'hidden' }}>
      ...
      >
        ...
        {/* Images related to hydro tools */}
        {/* <div className="image-container">
          <img src="/images/hydro_tool_1.jpg" alt="Hydro Tool 1" className="hydro-image" />
          <img src="/images/hydro_tool_2.jpg" alt="Hydro Tool 2" className="hydro-image" />
          <img src="/images/hydro_tool_3.jpg" alt="Hydro Tool 3" className="hydro-image" />
        </div> */}
      </motion.div>
    </div>
  );
